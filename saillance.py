...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fine_features=models.vgg19(weights=models.VGG19_Weights.IMAGENET1K_V1).features[0:30]
        self.coarse_features=models.vgg19(weights=models.VGG19_Weights.IMAGENET1K_V1).features[0:30]
    ...
    def forward(self, x):
        coarse_x = nn.functional.interpolate(x, (240,320))
